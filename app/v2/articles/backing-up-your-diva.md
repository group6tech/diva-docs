...
Please also see the guides on [configuring backups](/v2/articles/configuring-project-backups.html) and [restoring projects and bins](/v2/articles/restoring-projects-bins.html).
...
You can use the [project archive](/v2/articles/about-project-archiving.html) system to manually create one-off backups of your Avid projects.
